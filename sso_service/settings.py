...
#
# For local debugging/tests, set USE_SQLITE=true to avoid external DB dependency.
if _env_bool("USE_SQLITE", default=False):
    DATABASES = {
        "default": {
...
SSO_ALLOWED_REDIRECT_URIS = _env_list("SSO_ALLOWED_REDIRECT_URIS", "")
SSO_AUTH_CODE_LIFETIME_SECONDS = _env_int("SSO_AUTH_CODE_LIFETIME_SECONDS", 300)
DEVICE_AUTHORIZATION_LIFETIME_SECONDS = _env_int("DEVICE_AUTHORIZATION_LIFETIME_SECONDS", 600)
DEVICE_AUTHORIZATION_INTERVAL_SECONDS = _env_int("DEVICE_AUTHORIZATION_INTERVAL_SECONDS", 5)
DEVICE_ACCESS_TOKEN_LIFETIME_MINUTES = _env_int("DEVICE_ACCESS_TOKEN_LIFETIME_MINUTES", 5)
DEVICE_REFRESH_TOKEN_LIFETIME_DAYS = _env_int("DEVICE_REFRESH_TOKEN_LIFETIME_DAYS", 30)
DEVICE_VERIFICATION_URI = os.getenv("DEVICE_VERIFICATION_URI", "https://sso.arnatech.id/device/verify")
DEVICE_ALLOWED_AUDIENCES = _env_list("DEVICE_ALLOWED_AUDIENCES", "photobooth-api")
